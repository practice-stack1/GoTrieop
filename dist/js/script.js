...
var fixMenu = function fixMenu(menu_selector) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var mobMenu = function mobMenu(trigger_selector, menu_selector, menu_item, active_class) {
  ...
  if (parallax) {
    var setMouseParallaxStyle = function setMouseParallaxStyle() {
      ...
      circles.forEach(function (circle) {
        circle.style.cssText = "transform: translate(".concat(positionX / forCircle, "%,").concat(positionY / forCircle, "%);");
      });
      snakeses.forEach(function (snakes) {
        snakes.style.cssText = "transform: translate(".concat(positionX / forSnakes, "%,").concat(positionY / forSnakes, "%);");
      });
      requestAnimationFrame(setMouseParallaxStyle);
    };

    var circles = document.querySelectorAll('.circle');
    var snakeses = document.querySelectorAll('.snakes');
    var forCircle = 10;
    var forSnakes = 10;
    var speed = 0.5;
    var positionX = 0,
...
/***/ "./src/js/basic/slowAnchorMove.js":
/*!****************************************!*\
  !*** ./src/js/basic/slowAnchorMove.js ***!
  \****************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (slowmotion);

/***/ }),

/***/ "./src/js/basic/swiperConfig.js":
/*!**************************************!*\
  !*** ./src/js/basic/swiperConfig.js ***!
  \**************************************/
/*! no exports provided */
...
var mainSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.slider__swiper', {
  simulateTouch: true,
  touchRatio: 1,
  touchAngle: 45,
  grabCursor: true,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _basic_mobileMenu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./basic/mobileMenu */ "./src/js/basic/mobileMenu.js");
/* harmony import */ var _basic_slowAnchorMove__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./basic/slowAnchorMove */ "./src/js/basic/slowAnchorMove.js");
